          ...
          <div class="col-lg-5 pl-lg-5 pb-3 py-lg-5">
            <form action="/register" method="POST" id="registration-form">
              ...
              <div class="form-group">
                ...
                <input name="password" id="password-register" value="{{old('password')}}" class="form-control" type="password" placeholder="Create a password" />
                @error('password')
                    <p class="m-0 small alert alert-danger shadow-sm">{{$message}}</p>
                @enderror
              </div>
              ...
              <div class="form-group">
                ...
                <input name="password_confirmation" id="password-register-confirm" value="{{old('password_confirmation')}}" class="form-control" type="password" placeholder="Confirm password" />
                @error('password_confirmation')
                    <p class="m-0 small alert alert-danger shadow-sm">{{$message}}</p>
                @enderror
              </div>
  
              <button type="submit" class="py-3 mt-4 btn btn-lg btn-primary btn-block">Sign up for Postie</button>
            </form>
          </div>
        </div>
      </div>
